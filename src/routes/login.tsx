...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign In — G-TECH FRED" },
      { name: "description", content: "Sign in to your G-TECH FRED account." },
    ],
  }),
  component: LoginPage,
});
    ...
    <div className="phone-frame flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen px-6">
        ...
        <div className="pt-12 pb-4">
          <button onClick={() => navigate({ to: "/welcome" })} className="w-10 h-10 rounded-xl glass flex items-center justify-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-sm">Sign in to continue to G-TECH FRED</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex-1 flex flex-col">
          ...
          <div className="flex gap-3">
            <button type="button" className="flex-1 h-12 rounded-xl glass flex items-center justify-center gap-2 text-sm font-medium text-foreground">
